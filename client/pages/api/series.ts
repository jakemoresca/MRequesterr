...
import { ISeriesSettings } from '../../models/settings'
...
export async function getSeries(): Promise<IMedia[]> {
    const settings = await getSettings();

    const getMovieUrl = getServiceUrl(settings.integrationSettings.series, "/series");
